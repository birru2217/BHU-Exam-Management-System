...
4.  Download the SQL file from here: 👉 **[Download bhu.sql](https://github.com/birru2217/BHU-Exam-Management-System/raw/main/bhu.sql)**
5.  Upload the `bhu.sql` file and click **Go**.
